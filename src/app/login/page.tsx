...
const LoginPage = () => {
  return (
    <div className='p-4 h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] my-4 flex items-center justify-center'>
      {/* BOX */}
      <div className="h-full shadow-2xl rounded-md flex flex-col md:flex-row md:h-[80%] w-full lg:w-[60%] lg:h-[80%] 2xl:w-[50%]">
        {/* IMAGE CONTAINER */}
